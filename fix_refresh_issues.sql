-- =====================================================
-- FIX REFRESH ISSUES - SAFE SQL SCRIPT
-- =====================================================

-- 1. DROP EXISTING TRIGGERS (SAFE)
...
-- 3. DROP EXISTING KPI POLICIES (SAFE)
...
-- 7. CREATE SIMPLIFIED POLICIES FOR KPI_DATA
